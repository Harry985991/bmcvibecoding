  ...
  function buildReturnAssetTrendSeries(input = {}){
    ...
    const canAppendToday = !(typeof isBeforeTwseCloseSnapshotTime === 'function' && isBeforeTwseCloseSnapshotTime());
    if(canAppendToday && Number.isFinite(totalAssetsNow) && totalAssetsNow > 0 && !seen.has(todayLocalStr)){
